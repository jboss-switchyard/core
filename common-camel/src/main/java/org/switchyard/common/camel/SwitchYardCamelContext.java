...
import org.switchyard.common.camel.event.CamelContextCreatedEvent;
...
public class SwitchYardCamelContext extends DefaultCamelContext {
    ...
    /**
     * Public constructor, creates context and sets domain inside registry.
     * 
     * @param domain SwitchYard service domain.
     */
    public SwitchYardCamelContext(ServiceDomain domain) {
         this._domain = domain;
         ...
         eventPublisher.publish(new CamelContextCreatedEvent(this));
    }
