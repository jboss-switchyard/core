...
public class V1CompositeReferenceModel extends BaseNamedModel implements CompositeReferenceModel {
    ...
    public ComponentReferenceModel getComponentReference() {
        ...
        if (composite != null) {
            ...
            if (count > 0) {
                QName componentName = promote[0];
                QName componentReferenceName = (count == 2) ? promote[1] : null;
    ...
    public QName[] getPromote() {
        QName[] promote = XMLHelper.splitQNames(getModelAttribute(CompositeReferenceModel.PROMOTE));
        if (promote.length > 2) {
    ...
    public CompositeReferenceModel setPromote(QName[] promote) {
        ...
        setModelAttribute(CompositeReferenceModel.PROMOTE, str);
        return this;
    }
