...
public class RegistryImplementationTest {
    ...
    public void setUp() throws Exception {
        System.setProperty(ServiceRegistry.REGISTRY_CLASS_NAME, 
            MOCK_REGISTRY);
        System.setProperty(EndpointProvider.ENDPOINT_PROVIDER_CLASS_NAME, 
            MOCK_ENDPOINT_PROVIDER); 
    }
    
    @After
    public void tearDown() throws Exception {
        System.clearProperty(ServiceRegistry.REGISTRY_CLASS_NAME);
        System.clearProperty(EndpointProvider.ENDPOINT_PROVIDER_CLASS_NAME);
    }
    ...
    public void testSystemPropertiesSet() throws Exception {
        ...
        Assert.assertEquals(System.getProperty(ServiceRegistry.REGISTRY_CLASS_NAME), MOCK_REGISTRY);
        Assert.assertEquals(System.getProperty(EndpointProvider.ENDPOINT_PROVIDER_CLASS_NAME), MOCK_ENDPOINT_PROVIDER);               
