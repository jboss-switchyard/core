...
public class ForgeSwitchyardTest extends AbstractShellTest {
    ...
    private static final String _showConfigSuccessMsg = "[Public]\nservice: ForgeBeanService\n   interface: " +
    		"inherited\nreference: ForgeBeanServiceReferenceable\n   interface: inherited";
    ...
    private void testCreateServiceTest() throws Exception {
    	initializeOutputStream();
    	queueInputLines(SERVICE_TEST);
        getShell().execute("switchyard create-service-test");
        System.out.println(outputStream);
